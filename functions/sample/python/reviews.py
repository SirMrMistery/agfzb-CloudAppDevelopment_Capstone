...
cloudant_username = 'd56be666-33e8-492a-91d3-201d1790d277-bluemix'
cloudant_api_key = '77AhiMN5uYlrseIV9WdfAKfesy4PaTpTo1gQIJok0_Qn'
cloudant_url = 'https://d56be666-33e8-492a-91d3-201d1790d277-bluemix.cloudantnosqldb.appdomain.cloud'
...
@app.route('/dealership-package/get_reviews', methods=['GET'])
def get_reviews():
...
@app.route('/dealership-package/post_review', methods=['POST'])
def post_review():
    if not request.json:
